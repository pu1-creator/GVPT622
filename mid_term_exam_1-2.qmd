...
Answer:
50 is the mean of fifth and sixth people in the ten people group; The median of a nine people group is the age of fifth people. The age of 5th and 6th together is 100.
...
Answer:
The total age of ten people is 50*10 = 500,
...
Answer:
If the one left the room's age is X. The mean of nine people is (500-x)/9, which is larger than 50. So the X is smaller than 50 (500- 9 * 50 = 50).
...
Answer:
A&D, both of them are from a list of all U.S. residential addresses.
...
For those people who think the difference in incomes between rich people and poor people in the United States today is smaller, or about the same as it was 20 years ago, they do not have much difference views on Trump, and their view on Trump is relatively high.
 For those people who think the difference is large, their views on Trump is often much lower.
...
Answer:
First, I will have a control group that is not treated: a group of voting stations do not have free child care at election voting stations
Then, I will have a treatment groups: a group of  voting stations have free child care at election voting stations. The treatment group will be randomly choose from the US voting Stations. Because the treatment was dispursed randomly, the two groups can be compared, on average.
