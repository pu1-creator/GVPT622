...
Higher education is associated with higher political attention, people with higher levels of education tend to pay more attention to politics. Those with lower education are more likely to only pay attention to politic in sometimes of the times. Those with higher education (especially graduate degrees) are much more likely to pay attention with Most of the time or Always pay attention to politic.
...
In this cross-tab, I will have religious identification(attendance) as the independent variable, and support for Federal funding as dependent variable. Thus I will know the relationship between these two variables. The table will include the number and proportion of respondents for each level of funding according to how often they attend religious ceremonies. If the hypothesis is true, I would find higher proportions of respondents who regularly attend religious events select “too much.” And the crosss-tab data would show people who are identify as being religious less likely to support Federal government funding of scientific research.
