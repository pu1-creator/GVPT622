...
The answer for the 90% confidence interval is [27.65, 126.35]
### Question 2
...
```
From the two tail t-test with p-value of 0.01, we can reject the null hypothesis of no statistically meaningful difference.
### Question 3
...
75 / (155 + 255 + 75 + 35)
```
Answer: 0.1442308, the probability is 14.4%.
### Question 11
...
105 + 1.96 * (120/ sqrt(1600))
```
Answer: a 95% confidence interval around the sample statistic is [99.12, 110.88]
#### Part B

*2 points*

When testing the null hypothesis, what is the test statistic associated with the sample statistic?
Answer: We need an one-sample t-test statistic
...
```
With a p-value of 0.04779035, which is statistically significant, the one-tailed test will let us reject the null hypothesis.
## Applied questions
...
Answer: If Religion importance is Not important, the Turnout estimate 72.4% 
If Religion importance is Matters a great deal, the	Turnout estimate 82.4%
